...
module.exports = {
	 ...
	 */
	sendVerificationEmail: async (req, userInstance, userAttributeInstance) => {
	 ...
	 * @throws {Error} If an error occurs while sending the email.
	 */
	sendRequestResetPasswordEmail: async (req, userInstance, resetToken) => {
		// Send the email using our custom mailSender Function
		try {
			// TODO: Change action url to be front-end url
			const login_url = 'http://' + req.headers.host + '/login/';
	 ...
	 * @throws {Error} If an error occurs while sending the email.
	 */
	sendResetPasswordEmail: async (req, userInstance) => {
		// Send the email using our custom mailSender Function
		try {
			// TODO: Change action url to be front-end url
			const login_url = 'http://' + req.headers.host + '/login/';
